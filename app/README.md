...
Projeto das aulas da disciplina de Programação Móvel do Curso de Sistemas de Informação - IFAL - campus Arapiraca.
...
3. Utilize o comando (baixar) o projeto: `git clone https://github.com/tarsisms/aulaprmo.git`
   </br>
...
```shell
823fcd5 (HEAD -> main) Aula 06 - Interfaces Gráficas - 25/11
